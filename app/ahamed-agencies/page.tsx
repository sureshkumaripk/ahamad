          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 border border-white/30">
                <Sprout size={20} />
                <span className="text-sm font-medium">Professional Tools & Equipment</span>
              </div>

              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                <span className="block text-green-100">Tata Agrico Excellence</span>
                <span className="block text-white">Professional Tools & Equipment</span>
              </h1>

              <p className="text-xl text-green-100 leading-relaxed">
                Your trusted partner for premium agricultural tools, construction equipment, 
                industrial hardware, and professional-grade products. From garden tools to 
                welding electrodes, we provide everything you need for farming, construction, 
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="text-center bg-gradient-to-br from-green-500/30 to-green-600/30 backdrop-blur-sm rounded-xl p-4 border border-green-400/40">
                  ...
                  <div className="text-sm text-green-50">Tata Quality</div>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Link href="/ahamed-agencies/agri-construction-tools" className="bg-gradient-to-br from-green-300/20 to-green-400/20 backdrop-blur-sm rounded-xl p-4 text-center border border-green-200/30 hover:bg-green-300/30 transition-all duration-300 group cursor-pointer">
                  <Wrench size={32} className="mx-auto mb-2 group-hover:scale-110 transition-transform duration-300" />
                  <h4 className="font-semibold text-sm mb-1">Agri & Construction</h4>
                  <p className="text-xs text-green-100">Chaff Cutters, Tillers</p>
                </Link>
                <Link href="/ahamed-agencies/diy-tools" className="bg-gradient-to-br from-green-400/20 to-green-500/20 backdrop-blur-sm rounded-xl p-4 text-center border border-green-300/30 hover:bg-green-400/30 transition-all duration-300 group cursor-pointer">
                  <Hammer size={32} className="mx-auto mb-2 group-hover:scale-110 transition-transform duration-300" />
                  <h4 className="font-semibold text-sm mb-1">DIY Tools</h4>
                  <p className="text-xs text-green-100">Screwdrivers, Kits</p>
                </Link>
                <Link href="/ahamed-agencies/filing-tools" className="bg-gradient-to-br from-green-500/20 to-green-600/20 backdrop-blur-sm rounded-xl p-4 text-center border border-green-400/30 hover:bg-green-500/30 transition-all duration-300 group cursor-pointer">
                  <FileText size={32} className="mx-auto mb-2 group-hover:scale-110 transition-transform duration-300" />
                  <h4 className="font-semibold text-sm mb-1">Filing Tools</h4>
                  <p className="text-xs text-green-100">TATA AGRICO Files</p>
                </Link>
                <Link href="/ahamed-agencies/garden-tools" className="bg-gradient-to-br from-green-300/20 to-green-400/20 backdrop-blur-sm rounded-xl p-4 text-center border border-green-200/30 hover:bg-green-300/30 transition-all duration-300 group cursor-pointer">
                  ...
                  <p className="text-xs text-green-100">Cultivators, Shears</p>
                </Link>
                <Link href="/ahamed-agencies/industrial-hardware" className="bg-gradient-to-br from-green-400/20 to-green-500/20 backdrop-blur-sm rounded-xl p-4 text-center border border-green-300/30 hover:bg-green-400/30 transition-all duration-300 group cursor-pointer">
                  <Settings size={32} className="mx-auto mb-2 group-hover:scale-110 transition-transform duration-300" />
                  <h4 className="font-semibold text-sm mb-1">Industrial Hardware</h4>
                  <p className="text-xs text-green-100">Nails, Electrodes</p>
                </Link>
                <Link href="/ahamed-agencies/trade-hand-tools" className="bg-gradient-to-br from-green-500/20 to-green-600/20 backdrop-blur-sm rounded-xl p-4 text-center border border-green-400/30 hover:bg-green-500/30 transition-all duration-300 group cursor-pointer">
                  <Shield size={32} className="mx-auto mb-2 group-hover:scale-110 transition-transform duration-300" />
                  <h4 className="font-semibold text-sm mb-1">Trade Hand Tools</h4>
                  <p className="text-xs text-green-100">Spanners, Pliers</p>
                </Link>
              </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: Award, title: 'Quality Products', desc: 'All Tata Agrico products meet the highest quality standards and are backed by comprehensive warranties.' },
